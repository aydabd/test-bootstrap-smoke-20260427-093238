# =============================================================================
# test-bootstrap-smoke-20260427-093238 — Makefile
# =============================================================================
...
# Configuration
# =============================================================================
MAMBA_ENV  := test-bootstrap-smoke-20260427-093238
...
help: ## Show available make targets
	@echo "test-bootstrap-smoke-20260427-093238 — Available Commands:"
	@echo ""
...
ifeq ($(USE_MAMBA),1)
	...
	@# (ec, ruff, mypy, etc.) are found when git runs outside the env.
